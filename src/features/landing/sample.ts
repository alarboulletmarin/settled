 ...
 *
 * Ils décrivent un foyer cohérent, et pas six valeurs prises au hasard : 3 200 €
 * rentrent, 1 820 € de mois prévu dont 1 240 € déjà confirmés, une capacité
 * d'épargne qui est bien ce qui reste avant versement, et deux parts qui font
 * 100. Une grille dont les chiffres ne se recomposent pas se lit comme une
 * erreur — c'est vrai du vrai tableau de bord, ça l'est encore plus de celui qui
 * sert à le présenter.
 *
