...
/* Le prévisionnel et le reste à vivre avaient leur tuile ici. Ils sont
   maintenant deux rangées de `SituationSection`, avec la capacité d'épargne :
   trois lectures dérivées des deux flux, qui ne valent que lues ensemble — et
   dont la phrase qui les sépare ne s'affichait sur aucune tuile plate en
   demi-colonne mobile. Le calcul, lui, n'a pas bougé d'une ligne. */
