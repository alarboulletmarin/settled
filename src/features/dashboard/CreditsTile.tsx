    ...
    >
      ...
      <div className="flex flex-col gap-1">
        {/* Sans les centimes, seul chiffre de la grille dans ce cas — et pour
            ...
            gros que l'app affiche, et c'est celui qu'un emprunt immobilier
            porte. « 1 000 000,00 € » demande 237px là où la tuile n'en offre
            que 185 sur six colonnes, et le symbole se faisait trancher au bord.
            Sans eux, 187px : le million passe à toutes les largeurs, et huit
            chiffres avec lui jusqu'à 768px.
            Le DS §3 tranche la question : une lecture qui masque les centimes
            **arrondit** l'unité, elle ne la tronque pas — et deux centimes ne
            ...
            lisent entiers sur l'écran au bout du chevron, qui est fait pour
            ça. */}
