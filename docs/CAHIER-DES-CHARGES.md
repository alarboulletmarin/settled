...
**Les quatre soldes s'ouvrent sur une feuille** qui donne leur calcul et, surtout, ce qui les sépare de leurs voisines. La tuile entière est la cible : sur une rangée simple, un bouton d'aide et l'étiquette ne tiennent pas côte à côte.

La feuille n'est pas un confort, c'est la seule chose qui réponde dans le cas le plus embarrassant : **sans rentrée d'argent restant à venir, le reste à vivre prend la fin du mois pour horizon, donc il vaut le prévisionnel au centime.** Deux tuiles voisines annoncent alors deux fois le même montant sous deux noms. Leurs secondes lectures disent donc toutes deux **jusqu'où va le chiffre** — « jusqu'à la fin du mois, prévu compris » et « jusqu'à la prochaine rentrée d'argent » —, ce qui explique la coïncidence au lieu de la laisser passer pour une erreur. Elles ne s'affichent qu'au-delà de 1024px, comme toute seconde lecture de tuile plate ; en deçà, c'est la feuille qui les porte, et c'est exactement ce pour quoi elle existe.
...
**La grille garde ses tuiles de tailles inégales.** C'est ce qu'est un bento (design system §5), et sur les deux colonnes d'un téléphone ça n'existe que si des demi-colonnes se rangent côte à côte : quatre blocs pleine largeur empilés sont une pile de cartes, si inégales que soient leurs hauteurs. Trois paires portent donc le rythme — ce qui rentre et ce qui sort, les deux soldes qui les projettent, la répartition et les crédits —, et le solde du mois, l'anneau des postes et la capacité prennent la largeur entre elles. Le prix est celui du format plat : leurs secondes lectures attendent 1024px. Il est payé sciemment, parce que chacune de ces tuiles mène à l'écran ou à la feuille qui dit la même chose en entier.

**Les prochaines échéances sortent de la grille**, seules : ce n'est pas un chiffre qu'on lit d'un coup d'œil mais une liste qu'on parcourt, et sa hauteur doit venir de son contenu plutôt que d'un format — cinq lignes s'y serraient à un pixel d'interligne. Elle se lit en section sous la grille, avec les deux autres listes de l'écran.
