...
- **Où part l'argent** : répartition par famille, sur les charges et les crédits. L'épargne en est exclue et se lit à part — elle sort du compte mais reste au foyer. Et elle ne s'y lit pas non plus en seconde lecture : un « mis de côté » sous l'anneau se lisait au seul confirmé quand l'anneau compte aussi les prévues, et venait mêler à une répartition de dépenses un chiffre qui n'en est pas une. Ce qui est versé se dit sur **Capacité d'épargne** — avec ou sans filtre, et au confirmé assumé comme tel, en regard d'un reste à placer qui, lui, est prévisionnel — et se détaille sur l'écran de l'épargne. **Chaque part de la légende s'ouvre** sur les lignes du mois qu'elle compte (§4.4 bis) : les deux tuiles de flux mènent depuis longtemps à la liste filtrée sur leur nature, et voir « Logement 890 € » sans pouvoir demander ce qu'il y a dedans était un geste sans réponse. Le lien est sur la ligne et non sur la tuile — une tuile cliquable enfermerait la légende dans un bouton, et ne saurait pas laquelle des sept parts on visait. « Autres » ne s'ouvre pas : ce n'est pas une famille mais le reste de la liste.
- **Capacité d'épargne**, seconde lecture : deux clauses, « déjà versé · reste à placer ». La première dit ce qui est parti du compte — **au confirmé seul**, parce que c'est un constat : le 3 du mois, une tuile qui annonce trois cents euros que rien n'a fait partir se trompe. La seconde dit ce qu'il reste à décider, sur le mois entier, échéances comprises : un virement déjà programmé n'est pas un geste à prendre. Les deux ne se recomposent donc pas avec la capacité tant qu'un versement est en attente, et c'est le même registre que Revenus et « dont 141 € encore à venir ». Le constat se dit **avec ou sans filtre** : la somme d'épargnes individuelles ne décide de rien, ce qui vaut pour un reste à placer et non pour un fait — l'écran de l'épargne additionne d'ailleurs déjà les versements du foyer. Hors filtre et sous 1024px, le mois ne disait nulle part ce qu'il avait mis de côté, quand son solde comptait le versement comme une dépense. Les deux clauses n'ont pas le même seuil d'affichage : le constat tient en trois mots et suit la largeur de sa tuile, la phrase du reste attend 1024px (§ design system).
...
- Lecture : une tuile sur l'écran du mois, et un écran plein `/repartition` qui montre le calcul. La tuile s'efface sans revenus complets, sous un filtre par membre — une charge commune n'appartient à personne, aucune ne passerait le filtre — et dans un foyer d'une personne, où un anneau à 100 % n'apprendrait rien. Sous le filtre, c'est la tuile **Part du foyer** (§4.6) qui prend le relais : la même règle, lue du point de vue d'une seule personne, et le même écran de détail au bout — qui reste debout seul du foyer, avec une seule ligne à 100 % : c'est là que le pot se vérifie.
