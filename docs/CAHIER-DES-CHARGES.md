...
**Et c'est pourquoi les trois autres ne sont plus des tuiles.** Le prévisionnel, le reste à vivre et la capacité d'épargne se dérivent tous les trois des deux flux, à trois horizons différents : ils se lisent ensemble, sous une seule étiquette — « Situation » —, une rangée chacun. Une tuile chacun leur donnait le poids des chiffres dont ils sortent, et surtout **masquait ce qui les distingue**. La distinction n'est pas un ornement : sans rentrée d'argent restant à venir, le reste à vivre prend la fin du mois pour horizon, donc il vaut le prévisionnel **au centime**. Deux tuiles voisines annonçaient alors deux fois le même montant sous deux noms, et la phrase qui les sépare — l'horizon de chacun — vivait sur une lecture secondaire que la largeur d'une demi-colonne mobile n'affiche jamais. En rangée, elle passe à la ligne et se lit à toutes les largeurs. Même raison pour « versé » sur la capacité : le chiffre compte le mois entier, échéances prévues comprises, et le mot seul laissait croire à un virement déjà parti.

Les deux premières gardent leur feuille d'explication, qui donne leur calcul et ce qui les sépare de leurs voisines ; la capacité mène à l'écran de l'épargne, parce que la question qu'elle appelle est « où je la place » et non « qu'est-ce que c'est ». La rangée entière est la cible, et son repère dit lequel des deux gestes elle porte : chevron vers un écran, glyphe d'information pour une feuille qui s'ouvre sur place.

**La répartition entre personnes et les crédits sont deux rangées aussi**, pour une autre raison : ce ne sont pas des lectures du mois, ce sont deux écrans. On ne consulte pas trois fois par jour ce qu'on doit encore sur une voiture, et les deux tuiles menaient déjà à leur détail. Chacune se résume en une ligne — les parts de chacun, le capital restant dû et le nombre de crédits en cours — et l'anneau se retrouve entier au bout du chevron.

Reste dans la grille ce à quoi on répond d'un coup d'œil : le solde, les deux flux, où part l'argent, et sous un filtre par membre ce que la personne porte du commun. Les prochaines échéances en sortent aussi, mais parce que ce sont une liste : leur hauteur doit venir de leur contenu, pas d'un format.
