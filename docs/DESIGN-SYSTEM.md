...
Le prix de la demi-colonne est double, et il se mesure. La lecture secondaire attend 1024px — c'est écrit plus haut. Et le **chiffre** y touche son plancher : 104px de contenu à 320px n'acceptent que onze caractères, soit **100 000 € au plus**. Une tuile ne devient une moitié de rangée que si ces deux plafonds sont au-dessus de ce qu'elle a à dire, et que ce qu'elle masque se retrouve ailleurs — sur l'écran au bout de son chevron, sur la feuille qu'elle ouvre, ou sur les lignes vers lesquelles elle mène. Le capital restant dû d'un crédit est l'exemple du contraire : il porte les plus gros montants de l'app, il garde une `2×2`, et il renonce à ses centimes pour que le million passe.
